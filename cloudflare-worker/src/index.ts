...
export class TodoistMCP extends McpAgent {
  ...
  async init() {
    ...
    this.server.tool(
      ...
      {
        content: z.string().min(1, "Task content/title is required").describe("Task content/title (required, non-empty)"),
        description: z.string().nullable().optional().describe("Task description (optional)"),
        projectId: z.union([z.string(), z.number()]).nullable().optional().describe("Project ID (string, integer, or null) (optional)"),
        sectionId: z.union([z.string(), z.number()]).nullable().optional().describe("Section ID (string, integer, or null) (optional)"),
        parentId: z.union([z.string(), z.number()]).nullable().optional().describe("Parent ID (string, integer, or null) (optional)"),
        order: z.number().nullable().optional().describe("Order (integer or null) (optional)"),
        labels: z.array(z.string()).nullable().optional().describe("Array of label names (optional)"),
        priority: z.number().nullable().optional().describe("Priority (integer or null) (optional)"),
        assigneeId: z.number().nullable().optional().describe("Assignee ID (integer or null) (optional)"),
        dueString: z.string().nullable().optional().describe("Due date in natural language (string or null) (optional)"),
        dueDate: z.string().nullable().optional().describe("Due date (string or null) (optional)"),
        dueDatetime: z.string().nullable().optional().describe("Due datetime (string or null) (optional)"),
        dueLang: z.string().nullable().optional().describe("Due language (string or null) (optional)"),
        duration: z.number().nullable().optional().describe("Duration (integer or null) (optional)"),
        durationUnit: z.string().nullable().optional().describe("Duration unit (string or null) (optional)"),
        deadlineDate: z.string().nullable().optional().describe("Deadline date (string or null) (optional)"),
        deadlineLang: z.string().nullable().optional().describe("Deadline language (string or null) (optional)"),
      },
      async (args, extra) => {
        ...
        try {
          const task = await todoistClient.createTask({
            ...
            deadlineLang: args.deadlineLang,
          });
